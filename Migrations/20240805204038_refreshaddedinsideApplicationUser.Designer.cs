...
namespace trading_app.Migrations
{
    ...
    [Migration("20240805204038_refreshaddedinsideApplicationUser")]
    partial class refreshaddedinsideApplicationUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("trading_app.models.Wire", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("trading_app.models.ApplicationUser", null)
                        .WithMany()
